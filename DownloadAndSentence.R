...
# get list of profanity from ShutterStock github
if (!file.exists("./data/profanity.txt")) {
  download.file("https://raw.githubusercontent.com/shutterstock/List-of-Dirty-Naughty-Obscene-and-Otherwise-Bad-Words/master/en", destfile="./data/profanity.txt", method="auto")
}
